    ...
    private void getCurrentLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, location -> {
            if (location != null) {
                ...
                String address = locationManager.getAddressFromCoordinates(selectedLatitude, selectedLongitude);
                if (address != null && !address.isEmpty()) {
                    locationEditText.setText(address);
                } else {
                    // Fallback to showing coordinates
                    locationEditText.setText(String.format("%.6f, %.6f", selectedLatitude, selectedLongitude));
                }

                Toast.makeText(this, "Location captured!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Unable to get current location. Please enable location services.", Toast.LENGTH_SHORT).show();
            }
        });
    }
